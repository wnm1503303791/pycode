#魔改了一下代码的神经网络模型参数，极大增加了神经网络的神经元的数目
#tuzhuo, 2019-12-19
...
if __name__ == '__main__':
    ...
    for epoch in range(total_epoch):
        ...
        print("total cost in epoch %d : %s" % (epoch+1, total_cost))
